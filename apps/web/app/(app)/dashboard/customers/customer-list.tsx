  ...
  return (
    <ul className="space-y-2">
      {customers.map((c) => {
        ...
        return (
          <li key={c.id}>
            <article className="group flex items-center gap-4 rounded-2xl border border-border bg-surface p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-card sm:gap-5 sm:p-5">
